...
// ErrGetContainerName is
type ErrGetContainerName struct {
	err error
}
...
// Error is printing list services command err
func (e *ErrGetContainerName) Error() string {
	return fmt.Sprintf("get container name command: %s", e.err.Error())
}
